...
We'll soon release a Bridge Engine open source library containing Bridget's core functions like path planning, animation and scripting, as well as additional UI components, audio, and general mixed reality tools to help you develop with Bridge Engine.
We'll also be creating additional materials like video tutorials and more documentation.
